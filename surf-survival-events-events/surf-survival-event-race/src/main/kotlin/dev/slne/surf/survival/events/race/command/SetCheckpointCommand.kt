...
private val checkpointPos1 = mutableMapOf<UUID, Location>()
private val checkpointPos2 = mutableMapOf<UUID, Location>()

fun setCheckpointCommand() = subcommand("checkpoint") {
    ...
    playerExecutor { player, args ->
        ...
        when (argument) {
            ...
            "create" -> {
                val pos1 = checkpointPos1[player.uniqueId]
                val pos2 = checkpointPos2[player.uniqueId]
                ...
                checkpointPos1.remove(player.uniqueId)
                checkpointPos2.remove(player.uniqueId)
